...
* "Who knows how deep these data dumps will get?"
  ...
  * DO. NOT. RE. USE. PASSWORDS. Do [use password managers](https://github.com/AnarchoTechNYC/meta/tree/main/train-the-trainers/mr-robots-netflix-n-hack/week-2/strengthening-passwords-to-defend-against-john#using-a-password-manager) like [Bitwarden](https://bitwarden.com/), [KeePass](http://keepass.info/), [etc](https://prism-break.org/en/all/#password-managers).
