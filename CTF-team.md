...
We have partnered with [Tech Learning Collective](https://techlearningcollective.com/), one of the best and most politically-engaged cybersecurity educational groups that exist today, to offer unofficial cybersecurity training (on a volunteer/ad-hoc basis) during some CTFs that our members compete in. There is no fee to join. Simply enter [our general chat Lobby](https://gitter.im/AnarchoTechNYC/Lobby) during a CTF and say hello. [Check the Tech Learning Collective website for details about upcoming CTFs](https://techlearningcollective.com/events/ctfs) we may be available for.
