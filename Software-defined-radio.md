...
* [RTL-SDR](http://www.rtl-sdr.com/buy-rtl-sdr-dvb-t-dongles/) - Inexpensive (~$20), common peripheral based on the R820T2 chipset, which has a frequency range of  24 – 1766 MHz. (Also available from [HakShop](https://hakshop.com/collections/wireless-gear/products/software-defined-radio-kit-rtl-sdr) and [AdaFruit](https://www.adafruit.com/product/1497).)
